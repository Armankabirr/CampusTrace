...
function HomePage() {
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900 font-sora">
      ...
      <main>
        <section className="relative min-h-[750px] overflow-hidden pt-28 text-white">
          <img src={heroImage} alt="Campus building" className="absolute inset-0 h-full w-full object-cover" />
          <div className="absolute inset-0 bg-slate-950/60" />
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-slate-950/20 to-slate-950" />

          <div className="relative mx-auto flex min-h-[700px] w-full max-w-6xl flex-col items-center justify-center px-4 text-center">
            <p className="mb-6 rounded-full border border-amber-300/50 bg-brand-500/20 px-4 py-1 text-xs text-amber-100">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              <button className="rounded-xl bg-brand-500 px-6 py-3 text-sm font-semibold text-white transition hover:bg-brand-600" type="button">
                Report an Item
              </button>
              <button className="rounded-xl border border-white/30 bg-white/10 px-6 py-3 text-sm font-semibold text-white transition hover:bg-white/20" type="button">
                Browse Items
              </button>
            </div>
            ...
            <div className="mt-14 grid w-full max-w-4xl grid-cols-1 gap-4 md:grid-cols-3">
              {stats.map((item) => (
                <div
                  key={item.label}
                  className="rounded-2xl border border-white/20 bg-white/10 p-6 shadow-soft backdrop-blur"
                >
        ...
        <section className="bg-slate-100 px-4 pb-20 pt-16">
          <div className="mx-auto max-w-6xl text-center">
            <span className="inline-block rounded-full bg-brand-100 px-3 py-1 text-xs font-semibold text-brand-600">
              Simple Process
            </span>
            <h2 className="mt-4 text-4xl font-bold text-slate-900">How It Works</h2>
            ...
            <div className="mt-12 grid gap-4 md:grid-cols-2">
              {steps.map((step, index) => (
                <article
                  key={step.title}
                  className="group relative rounded-2xl border border-slate-200 bg-white p-6 text-left shadow-sm transition hover:-translate-y-1 hover:shadow-soft"
                >
        ...
        <section className="bg-gradient-to-b from-slate-100 to-amber-50 px-4 pb-20">
          <div className="mx-auto grid max-w-6xl gap-8 rounded-3xl bg-white p-6 shadow-soft lg:grid-cols-2 lg:p-10">
            ...
            <div className="flex flex-col justify-center">
              ...
              <h2 className="mt-3 text-4xl font-bold text-slate-900">Why Choose CampusTrace?</h2>
        ...
        <section className="px-4 pb-14">
          <div className="mx-auto max-w-4xl overflow-hidden rounded-3xl bg-gradient-to-r from-brand-500 via-amber-500 to-brand-600 px-6 py-16 text-center text-white shadow-soft">
